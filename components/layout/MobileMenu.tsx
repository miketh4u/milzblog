      ...
      <div className="absolute right-0 top-0 bottom-0 w-4/5 max-w-sm bg-[var(--color-background)] shadow-2xl flex flex-col">
        ...
        <div className="p-6 border-t border-[var(--color-border)]">
          <div className="flex items-center gap-4">
            ...
            <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="w-11 h-11 flex items-center justify-center rounded-full bg-[var(--color-surface)] text-[var(--color-text-muted)]">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
