      ...
      <div className="absolute right-0 top-0 bottom-0 w-4/5 max-w-sm bg-[var(--color-background)] shadow-2xl flex flex-col">
        ...
        <div className="p-6 border-t border-[var(--color-border)]">
          <div className="flex items-center gap-3">
            <a href="https://www.instagram.com/the_milz_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-11 h-11 flex items-center justify-center rounded-full bg-[var(--color-surface)] text-[var(--color-text-muted)]">
